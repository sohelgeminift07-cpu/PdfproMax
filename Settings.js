...
function Settings(_a) {
    ...
    return (React.createElement("div", { className: "fixed inset-0 z-[100] flex flex-col justify-end" },
        ...
        React.createElement("div", { className: "bottom-drawer-shell settings-shell".concat(closing ? ' slide-out-down' : ' slide-in-from-bottom-full'), style: { height: '88vh', maxWidth: '768px', transform: "translateY(".concat(dragY, "px)") } },
            ...
            React.createElement("div", { className: "settings-header" },
                React.createElement("div", { className: "settings-title-wrap" },
                    React.createElement("p", { className: "settings-kicker" }, "Preferences"),
                    React.createElement("h2", { className: "settings-title" }, "Customize your reading experience")),
                React.createElement("div", { className: "settings-tab-row" },
                    [
                        ...
                        React.createElement("label", { htmlFor: t.id, className: "settings-tab-pill" },
                            React.createElement("span", { className: "ct-icon" }, t.icon),
                            React.createElement("span", { className: "ct-text" }, t.label)))); }))),
            React.createElement("div", { className: "flex-grow overflow-y-auto custom-scrollbar settings-body p-6" },
                (function() {
                if (activeTab === 'general') return React.createElement("div", { className: "space-y-8 animate-in fade-in" },
                    ...
                    React.createElement("div", { className: "space-y-3 max-w-xl" },
                        React.createElement("label", { className: "text-xs font-bold text-rose-400 uppercase tracking-widest block" }, "Interliner Text Color"),
