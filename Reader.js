...
function Reader(_a) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            result_2 = {};
                            geminiModel = currentModel === 'gemini-lite' ? 'gemini-1.5-flash' : 'gemini-2.0-flash';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        gemM = customizerModel === 'gemini-lite' ? 'gemini-1.5-flash' : 'gemini-2.0-flash';
    ...
    var performInterlinearTranslation = function(pageIdx) {
        ...
        geminiGenerate(apiKeyRef.current, 'gemini-1.5-flash', userMsg, {
    ...
    var performEntityScan = function(pageIdx) {
        ...
        geminiGenerate(apiKeyRef.current, 'gemini-1.5-flash', 'Text:\n' + pageText.slice(0, 5000), {
            systemInstruction: sysMsg,
            temperature: 0.1,
