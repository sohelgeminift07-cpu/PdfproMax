...
function Reader(_a) {
    ...
    }, [pdfDoc, currentPage, scanningStatus, pdfRange, activeScanningModel, googleApiKey, boldingLevel, structureMode]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        gemM = customizerModel === 'gemini-lite' ? 'gemini-3.1-flash-lite-preview' : 'gemini-2.0-flash';
    ...
    return (React.createElement("div", { className: "w-full flex flex-col min-h-screen px-4 pb-40" },
        ...
        React.createElement("div", { className: "flex-grow pt-36 pb-20 manuscript-container" },
            React.createElement("div", { ref: containerRef, className: "manuscript-text serif text-xl ".concat(getThemeTextClass()), style: { lineHeight: lineSpacing } }, renderContent())),
