...
function Reader(_a) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            url = 'https://generativelanguage.googleapis.com/v1beta/models/' + geminiModel + ':generateContent?key=' + (apiKeyRef.current || GEMINI_KEYS[0] || '');
                            /* OCR via gemini direct to Google API */
    ...
    var performRewrite = function (mode_1) {
        ...
        return __awaiter(_this, __spreadArray([mode_1], args_1, true), void 0, function (mode, customInstruction, targetPage, retryCount) {
            var origText, prevText, nextText, boldMap, boldI, promptI, prevBlock, nextBlock, fullP, newText_1, gemM, r, resGen, modelId, key, endpoint, d, e_5;
    ...
    return (React.createElement("div", { className: "w-full flex flex-col min-h-screen px-4 pb-40" },
        ...
        isOriginalPdfOpen && pdfFile && (React.createElement("div", { className: "fixed inset-0 z-[200] flex flex-col bg-[#0a0a0c]" },
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("button", { onClick: function() { setIsOriginalPdfOpen(false); }, style: { width: '44px', height: '44px', borderRadius: '12px', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', color: '#f87171', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' } },
                    React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5" },
            ...
            React.createElement("div", { className: "dock-glow-wrap" + (activeGlowBtn ? ' dg-active' : ''), style: { flexDirection: 'column', alignItems: 'center' } },
                ...
                React.createElement("div", { style: { position:'relative', display:'flex', flexDirection:'column', alignItems:'center', zIndex:1 } },
                    ...
                    React.createElement("button", { onClick: function () { return currentPage < totalPages - 1 && setCurrentPage(function (p) { return p + 1; }); }, disabled: currentPage === totalPages - 1, className: "flex items-center justify-center w-9 h-9 shrink-0 rounded-full transition-all disabled:opacity-20 ".concat(readerTheme === 'light' ? 'text-slate-600 hover:bg-black/5' : 'text-slate-400 hover:text-white hover:bg-white/10') },
                        React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" },
                            React.createElement("path", { d: "m9 18 6-6-6-6" }))))))),
        activeRewriteMode && rewrittenPages[currentPage] && !rewritingStatus[currentPage] && React.createElement('button', {
            onMouseDown: function() { setIsComparing(true); },
            onTouchStart: function(e) { e.preventDefault(); setIsComparing(true); },
            onMouseUp: function() { setIsComparing(false); },
            onMouseLeave: function() { setIsComparing(false); },
            onTouchEnd: function() { setIsComparing(false); },
            onTouchCancel: function() { setIsComparing(false); },
            style: {
                position: 'fixed',
                bottom: '80px',
                right: '16px',
                ...
                padding: '10px 16px',
                borderRadius: '999px',
                border: '1px solid rgba(99,130,200,0.4)',
                background: isComparing ? 'rgba(99,130,200,0.4)' : 'rgba(30,40,70,0.85)',
                color: '#c7d8f8',
                fontWeight: 700,
                fontSize: '11px',
        ...
        }, '\ud83d\udc41 ', isComparing ? 'Showing original...' : 'Hold to see original'))));
}
