...
function MaxDrawer(_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    gemApiModel = mToUse === 'gemini-lite' ? 'gemini-2.5-flash' : 'gemini-2.5-flash';
    ...
    var generateTimeline = function (modelOverride, forceRegen) {
        ...
        var gemApiModel = mToUse === 'gemini-lite' ? 'gemini-2.5-flash' : 'gemini-2.5-flash';
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    gemApiModel = activeChatModel === 'gemini-lite' ? 'gemini-2.5-flash' : 'gemini-2.5-flash';
